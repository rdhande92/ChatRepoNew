...
def get_response_llm(question):
    ...
    context = vector_store.similarity_search(question, k=10)  # Retrieve top 3 most similar chunks

    prompt = f"""You are a helpful assistant, you have good knowledge in coding and you will use 
                the provided context to answer user questions with detailed explanations.
                ...
                strictly reply with 'Out-of-scope questions."""
...
print(get_response_llm("What is the GitHub URL for Bug Tracker?"))